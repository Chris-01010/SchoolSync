    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex font-['Inter']">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 p-6 flex flex-col gap-8 hidden lg:flex">
        ...
        <nav className="flex flex-col gap-1.5 flex-1">
          <div className="text-[10px] uppercase font-bold text-slate-400 tracking-widest px-4 mb-2">Main Menu</div>
        ...
        <div className="mt-auto p-4 bg-slate-50 rounded-2xl border border-slate-100">
          ...
          <p className="text-[10px] text-slate-500 mt-1">{user.college_id}</p>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 border-l border-slate-200 pl-6">
              <div className="text-right hidden sm:block">
                <p className="text-xs font-bold text-slate-900">{user.college_id}</p>
                <p className="text-[10px] text-slate-500">{user.role.toUpperCase()}</p>
              </div>
              <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-primary-600 to-blue-400 border-2 border-white shadow-sm ring-1 ring-slate-200"></div>
            </div>
          </div>
        </header>
              ...
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight mb-1">
                    {activeTab === 'dashboard' ? 'School Overview' : activeTab.charAt(0).toUpperCase() + activeTab.slice(1)}
                  </h1>
                  <p className="text-slate-500 font-medium">Wednesday, May 6, 2026</p>
                </div>
                <button 
