...
const ApplyLeaveModal = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleFile = (file) => {
    ...
    reader.onload = (ev) => {
      setForm((f) => ({ ...f, file, fileDataUrl: ev.target.result }));
      setEncoding(false);
    };
    reader.onerror = () => {
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div
              className="bg-white rounded-2xl shadow-2xl w-full max-w-[520px] pointer-events-auto border border-gray-100 overflow-hidden"
                ...
                <div>
                  ...
                  {!form.file && (
                    <div
                      ...
                      className={`border-2 border-dashed rounded-xl p-5 flex flex-col items-center justify-center gap-2 cursor-pointer transition-all ${dragging
                    ...
                    <div className="flex items-center gap-2.5 px-3 py-2.5 bg-green-50 border border-green-200 rounded-xl">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-green-600">
                          {(form.file.size / 1024).toFixed(0)} KB · ready to attach
                        </p>
                      </div>
                      <button
                        type="button"
