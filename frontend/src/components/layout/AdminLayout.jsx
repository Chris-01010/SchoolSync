...
const navItems = [
  ...
  { id: "timetables",  label: "Timetables",         icon: CalendarDays,  path: "/timetables" },
  { id: "relief",      label: "Relief Management",  icon: ShieldCheck,   path: "/relief" },
  { id: "leave",       label: "Leave Oversight",     icon: FileText,      path: "/leave" },
  { id: "users",       label: "User Management",    icon: Users,         path: "/users" },
  { id: "departments", label: "Departments",         icon: Building2,     path: "/departments" },
  { id: "rooms",       label: "Rooms & Resources",  icon: DoorOpen,      path: "/rooms" },
  { id: "analytics",   label: "Analytics",           icon: BarChart3,     path: "/analytics" },
  { id: "reports",     label: "Reports",             icon: ClipboardList, path: "/reports" },
  { id: "announce",    label: "Announcements",       icon: Megaphone,     path: "/announcements" },
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            {/* logout */}
            <button className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm font-medium text-gray-600 transition hover:bg-red-50 hover:text-red-600">
              <LogOut size={15} />
              Logout
            </button>
          </div>
        ...
        >
          ...
          <footer className="mt-10 border-t border-gray-200 pt-5 pb-4 text-center text-xs text-gray-400">
            © 2024 All Rights Reserved | Audit Log | System Status: Operational
            | v2.4.0-stable
          </footer>
        </main>
      </motion.div>
