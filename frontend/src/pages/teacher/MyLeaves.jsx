...
function mapLeave(raw) {
  ...
  const status = rawStatus.includes('clarif')
    ? 'clarification_requested'
    : rawStatus;
  ...
  return {
    ...
    days:
      raw.period_end && raw.period_start
        ? (
            raw.period_end -
            raw.period_start +
            1
    ...
    clarificationNote:
      raw.clarification_note || null,

    document:
      raw.handover_url || null,
      ...
      >
        ...
        <div className="space-y-3 text-[12px]">
          ...
          <div>
            ...
            <p className="text-gray-700 bg-gray-50 rounded-lg p-2.5 leading-relaxed">
              {req.reason || '—'}
            </p>
          </div>
          ...
          {req.clarificationNote && (
            <div>
              <p className="text-purple-600 font-bold mb-1 uppercase text-[10px] tracking-wide">
                Clarification Requested
              </p>

              <p className="text-purple-900 bg-purple-50 rounded-lg p-2.5 border border-purple-200">
                {req.clarificationNote}
              </p>
            </div>
          )}
...
const LeaveCard = ({
  ...
  return (
    ...
    >
      ...
      {req.reason && (
        <p className="text-[11px] text-gray-500 mt-2.5 pl-10 leading-relaxed">
          {req.reason}
        </p>
      )}
...
export default function MyLeaves() {
  ...
  const [viewReq, setViewReq] =
    useState(null);

  const [editReq, setEditReq] =
    useState(null);

  const [cancelReq, setCancelReq] =
    useState(null);
