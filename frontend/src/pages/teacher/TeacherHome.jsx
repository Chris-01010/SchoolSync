...
import { useTeacherProfile, useTeacherNotifications, useTeacherReliefConfirmed } from '../../hooks/useTeacherData';
...
export default function TeacherHome() {
  ...
  const stats = {
    ...
    totalTeachingHoursWeek:  profile?.teachingHours?.completed ?? 0,
    totalReliefHoursWeek:    profile?.reliefHours?.completed ?? 0,
  };
  ...
  const STATS = [
    ...
    },
    {
      ...
      value: stats.totalTeachingHoursWeek,
    ...
    },
    {
      ...
      value: stats.totalReliefHoursWeek,
  ...
  // Map confirmed reliefs to the shape ReliefCard expects
        ...
        <div className="bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="p-3 space-y-2">
            {activeReliefDutiesToday.length === 0 ? (
              ...
              activeReliefDutiesToday.slice(0, 3).map((item, i) => (
