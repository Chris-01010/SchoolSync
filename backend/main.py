...
# ─── Form-based login (OAuth2 standard) ───────────────────────────────────────
...
async def get_teacher_dashboard(current_user: models.User = Depends(auth.get_current_user), db: AsyncSession = Depends(get_db)):
    ...
    return {
        "timetable": timetable_data or [{"day": 0, "period": 1, "subject": "Maths", "class": "Grade 10A", "room": "201"}, {"day": 0, "period": 2, "subject": "Maths", "class": "Grade 10B", "room": "202"}],
